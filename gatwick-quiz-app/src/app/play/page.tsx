...
export default function PlayPage() {
  ...
  // Mock data - Replace with Supabase/FlightLabs data later
  const questions = [
    {
      ...
      {!isQuizComplete ? (
        <>
          ...
          <div className="bg-white p-8 rounded-3xl shadow-xl flex-grow flex flex-col justify-center items-center text-center gap-6 border-2 border-white relative overflow-hidden">
            ...
            {selectedAnswer && (
              <div
                className={`absolute inset-0 flex flex-col items-center justify-center bg-white/90 backdrop-blur-sm transition-all duration-300`}
              >
                {isCorrect ? (
